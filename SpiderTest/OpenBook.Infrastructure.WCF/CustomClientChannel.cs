...
namespace OpenBook.Infrastructure.WCF
{
    public class CustomClientChannel<T> : ChannelFactory<T>
    {
        ...
        public CustomClientChannel(Binding binding, string configurationPath) : this(binding, "", configurationPath)
        {
        }
        ...
        protected override ServiceEndpoint CreateDescription()
        {
            ...
            serviceEndpoint.Name = (string.IsNullOrEmpty(this.endpointConfigurationName) ? string.Empty : this.endpointConfigurationName);
